<template>
	<div>
		<m-navbar border @left-click="goBack" title-class="mvi-font-h4 mvi-text-bold" :title="room.room_id ? room.room_id + '【' + (room.room_type == 0 ? '比鸡' : '炸鸡') + '】' : '对局详情'" fixed :style="{ background: $store.getters.theme.data.basic, color: '#fff' }" left-icon="angle-left"></m-navbar>
		<div class="app-main">
