<template>
	<div class="mvi-pb-2">
		<m-navbar border @left-click="goBack" title="历史记录" fixed :style="{ background: $var.basic, color: '#fff' }" left-icon="angle-left" right-icon="refresh" @right-click="reset"></m-navbar>
		<div class="app-rooms">
		...
		<m-page class="mvi-mt-4 app-page" v-if="pageObject.pageCounts && pageObject.pageCounts > 0" :color="$var.light" @model-change="queryHistory" v-model="pageObject.pageCurrent" :total="pageObject.pageCounts"></m-page>
	</div>
</template>
